...
namespace mscv { namespace utils { namespace fs {


CV_EXPORTS bool exists(const mscv::String& path);
CV_EXPORTS bool isDirectory(const mscv::String& path);

CV_EXPORTS void remove_all(const mscv::String& path);


CV_EXPORTS mscv::String getcwd();
 ...
 */
CV_EXPORTS mscv::String canonical(const mscv::String& path);

/** Join path components */
CV_EXPORTS mscv::String join(const mscv::String& base, const mscv::String& path);
 ...
 */
CV_EXPORTS void glob(const mscv::String& directory, const mscv::String& pattern,
        CV_OUT std::vector<mscv::String>& result,
 ...
 * @param includeDirectories include directories into results list
 */
CV_EXPORTS void glob_relative(const mscv::String& directory, const mscv::String& pattern,
        CV_OUT std::vector<mscv::String>& result,
        bool recursive = false, bool includeDirectories = false);


CV_EXPORTS bool createDirectory(const mscv::String& path);
CV_EXPORTS bool createDirectories(const mscv::String& path);

#ifdef __OPENCV_BUILD
// TODO
//CV_EXPORTS mscv::String getTempDirectory();
 ...
 */
CV_EXPORTS mscv::String getCacheDirectory(const char* sub_directory_name, const char* configuration_name = NULL);
