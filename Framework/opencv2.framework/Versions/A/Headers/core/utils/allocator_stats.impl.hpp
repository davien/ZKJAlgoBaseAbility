...
namespace mscv { namespace utils {
...
public:
    ...
    {
#ifdef CV__ALLOCATOR_STATS_LOG
        CV__ALLOCATOR_STATS_LOG(mscv::format("allocate: %lld (curr=%lld)", (long long int)sz, (long long int)curr.load()));
#endif
    ...
    {
#ifdef CV__ALLOCATOR_STATS_LOG
        CV__ALLOCATOR_STATS_LOG(mscv::format("free: %lld (curr=%lld)", (long long int)sz, (long long int)curr.load()));
#endif
        curr -= (counter_t)sz;
    }
...
public:
    ...
    {
#ifdef CV__ALLOCATOR_STATS_LOG
        CV__ALLOCATOR_STATS_LOG(mscv::format("allocate: %lld (curr=%lld)", (long long int)sz, (long long int)curr));
#endif
    ...
    {
#ifdef CV__ALLOCATOR_STATS_LOG
        CV__ALLOCATOR_STATS_LOG(mscv::format("free: %lld (curr=%lld)", (long long int)sz, (long long int)curr));
#endif
