...
//  MSMNN
//
//  Created by MSMNN on 2019/11/25.
//  Copyright © 2018, Alibaba Group Holding Limited
//

#ifndef MSMNN_Train_Module_hpp
#define MSMNN_Train_Module_hpp
...
public:
    ...
    struct BackendInfo {
        MSMNNForwardType type = MSMNN_FORWARD_CPU;
    ...
    static Module* load(const std::vector<std::string>& inputs, const std::vector<std::string>& outputs, const char* fileName, const std::shared_ptr<MSMNN::Express::Executor::RuntimeManager> rtMgr, const Config* config = nullptr);
    static Module* load(const std::vector<std::string>& inputs, const std::vector<std::string>& outputs, const uint8_t* buffer, size_t length, const std::shared_ptr<MSMNN::Express::Executor::RuntimeManager> rtMgr, const Config* config = nullptr);
    ...
    struct Info {
        ...
        // Runtime Info
        std::shared_ptr<MSMNN::Express::Executor::RuntimeManager> runTimeManager;
        // Input Names By Order
        std::vector<std::string> inputNames;
        // Output Names By Order
        std::vector<std::string> outputNames;
        // The MSMNNConvert's Version build the module
        std::string version;
    };
