...
//  MSMNN
//
//  Created by MSMNN on 2018/07/23.
//  Copyright © 2018, Alibaba Group Holding Limited
//

#ifndef MSMNN_Interpreter_hpp
#define MSMNN_Interpreter_hpp
...
struct ScheduleConfig {
    ...
    MSMNNForwardType backupType = MSMNN_FORWARD_CPU;
...
class MSMNN_PUBLIC OperatorInfo {
    struct Info;
...
typedef std::pair< std::map<MSMNNForwardType, std::shared_ptr<Runtime>>,  std::shared_ptr<Runtime>> RuntimeInfo;

/**
 * @brief get mnn version info.
 * @return mnn version string.
 */
MSMNN_PUBLIC const char* getVersion();

/** net data holder. multiple sessions could share same net. */
class MSMNN_PUBLIC Interpreter {
public:
    /**
    ...
    enum SessionMode {
        ...
        Session_Backend_Auto = 9, // Auto Determine the Op type by MSMNN
    };
    /**
